...
更新日期：2026-08-31
当前项目目录：`/Users/suxiangdong/code/home-design`
...
- 厨房已移至一层北侧中部，餐厅位于其东侧，书房位于东北角。厨房后门仍位于厨房北墙的西端。
- 从后视画面看，厨房后门位于偏中位置，不能放在最左或最右外角。
...
- 一层入口墙向北内退约 0.70 m；入户门廊较原位置累计向东平移约 0.70 m。
- 一层主卧 B 南墙相对客厅南墙向北内退约 0.50 m，与正面效果图的左侧体块层次一致。
- 一层北侧次卧、厨房、餐厅和书房采用约 3.25 m 的浅进深；厨房、餐厅整体左移，书房位于东北角。
...
一层室内核心结构关系基本保持；南立面体块根据效果图校正，主卧 B 南墙相对客厅后退约 0.50 m。

- A01：入户门廊，位于阳台下方雨棚范围；在当前方案基础上再向东平移 0.50 m，累计较原位置向东平移约 0.70 m，入户门在移动后的门廊中居中。
- A02：玄关，鞋柜紧贴玄关东侧实体墙布置。
- A03/A04：客厅/大厅，与餐厅连续；沙发保持南北向，沙发、茶几及配套座椅整体向东移动约 0.90 m，但沙发东侧不得越过入户门西侧边线；电视设置在客厅西墙。
- A05：主卧 B，南墙相对客厅内退约 0.50 m；北侧公卫/前厅带北移后，参考净尺寸扩大为约 4.00 x 4.00 m；房门与 A08 次卧门洞中心线仍相对对齐。
- A05-1：开放式通长衣柜，采用左右更长、上下更窄的横向比例。
- A06：开放前厅，右侧保持开放，并设置通透屏风。
- A07：公卫/PS1，约 2.30 x 1.60 m，含淋浴；设置向开放前厅外开的平开门，避免门扇与洁具冲突。
- A08：次卧，北侧浅进深布置，约 4.00 x 3.00 m。
- A09：双跑楼梯间，每跑净宽参考约 1.00 m。
- A10：一层书房，移至东北角，约 3.75 x 3.00 m；从书房南侧独立过道进入。取消书房的要求仅针对二层。
- A11：开放式餐厅，随厨房整体左移，位于厨房东侧、书房西侧。
- A12：厨房，移至北侧中部，参考尺寸约 3.40 x 3.00 m。
- A13：主卧 A，南向体块外突约 1.00 m。
- A14：衣帽间 A。
- A15：主卫/PS2，约 2.38 x 2.00 m。
- C01：书房与右侧主卧套房之间的横向过道，避免进入书房或主卧时互相干扰。

一层使用约束：

- 一层所有卧室床的长轴统一东西向布置，床头靠西；门扇开启和主要通道保持净空。
- 厨房不设置外窗；北墙除后门外和南墙用于布置橱柜，并配置机械排烟与补风。
- 厨房必须设置机械排烟与补风。
- 厨房与餐厅之间的整段共享墙采用四扇通高推拉门，不保留两侧实墙段或小门；厨房北墙、东墙继续用于连续橱柜。
...
- B04：公卫/PS1，与一层 A07 湿区叠合；设置向开放前厅外开的平开门，门洞与一层对应。
- B05：开放前厅，右侧保持开放并设置通透屏风。
- B06：次卧 2，带开放式通长衣柜。
- B06-1：横向通长衣柜。
- B01：次卧 1 随一层西侧湿区对位调整为约 4.00 x 3.00 m。
- B07：次卧 3 随右侧湿区对位调整为约 4.42 x 3.00 m。
- B08：主卧衣帽间。
- B09：主卫/PS2，与一层 A15 湿区叠合。
- B10：主卧套房，包含衣帽间和主卫。
- C02：二层右侧横向过道，与一层 C01 对应；用于分隔次卧 3 与主卧套房。

二层所有卧室床的长轴统一东西向布置，床头靠西；床体不得占用房门开启区域或主要通道。
...
- 一层北侧重排后，B04、B09 已随 A07、A15 同步移动，继续保持上下垂直对位。
- PS1、PS2 沿湿区墙角集中设置。
- 污废水立管上下直通，尽量减少横支管。
...
- 左侧一层主卧 B 南墙较客厅南墙内退约 0.50 m，在一层平面轮廓中形成清晰折线。
...
- 正面需保留主卧 B 内退、入口内退、客厅体块层次、一层右主卧外突和二层内退阳台。
...
- [ ] 一层主卧 B 南墙相对客厅南墙内退约 0.50 m。
- [ ] 一、二层全部卧室床长轴均为东西向。
- [ ] 一层客厅座位组已向东移动，沙发东侧仍未越过入户门西侧边线。
- [ ] 二层右侧没有小露台。
